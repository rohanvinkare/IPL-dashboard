...
const PointsTable = () => {
  // Data link {https://rapidapi.com/cricketapilive/api/cricbuzz-cricket/playground/apiendpoint_289380b9-1ae3-4679-932b-2d0666a20083}
  ...
  return (
    ...
    // Also we can directly destructure the data
    <div className="w-full p-3">
      <table className="w-full">
        <tr className="text-center w-full  h-[4%]">
          <td className="text-left sm:w-[10%]  lg:w-[30%]">Team</td>
          <td>M</td>
          <td>W</td>
          <td>L</td>
          <td>NRR</td>
        ...
        {tableData.length <= 0 ? (
          ...
          tableData.map(
            (
              ...
              <tr
                key={i}
                className="text-center w-full border-t border-gray-200/70 h-[4%]"
              >
                ...
                <td className="flex gap-2 justify-center">
                  {form
                    ...
                    .map((data) =>
                      data === "W" ? (
                        <i className="fi fi-sr-check-circle text-green-500 text-sm"></i>
                      ) : (
